		...
		<div class="col-md-6">
			<div class="image-upload">
			  <label for="lxed_txt_img_block_inp<?php echo $section_id;?>" data-section_id="<?php echo $section_id;?>">
				<img class="lxed_txt_img_block_inpimg lxed_txt_img_block_inpimg<?php echo $section_id;?>" data-section_id="<?php echo $section_id;?>" src="<?php echo lx_plugin_url.'assets/img/sample_broken_img.jpg';?>" style="border:1px solid #000;width:100%;" />
			  </label>
