...
<div class="lxed_delete_buttonblock" style="text-align:end;">
	...
	<div class="image-upload" style="text-align:center;">
	  <label for="lxed_img_block_inp<?php echo $section_id;?>" style="width:unset;">
		<img class="lxed_img_block_inpimg lxed_img_block_inpimg<?php echo $section_id;?>" data-section_id="<?php echo $section_id;?>" src="<?php echo lx_plugin_url.'assets/img/sample_broken_img.jpg';?>" style="border:1px solid #000;" />
	  </label>
