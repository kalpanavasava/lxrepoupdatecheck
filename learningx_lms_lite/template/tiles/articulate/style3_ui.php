...
<div class="<?php echo $breakpoint['class'];?>">
	<div class="card <?php if( $open_in == "lightbox" ){ echo "content_card card_course_content_lightbox"; } ?> style_3_main_div <?php if( $info == "course_content_info" ){ echo "default_com_info"; } ?>" data-lession_id="<?php echo $post->ID;?>" data-content_type="<?php echo $content_type;?>" data-is_login="<?php echo $login;?>">
