<?php 
global $square_icon,$style_2_tiles_interface,$lx_plugin_urls,$breakpoint;
/* echo $post->ID; */
/* vwpr($open_in); */
?>
<style>
...
<div class="<?php echo $breakpoint['class'];?>">
	<div class="card style_2_main_div <?php if( $open_in == "lightbox" ){ echo "content_card card_course_content_lightbox"; } ?>" data-lession_id="<?php echo $post->ID;?>" data-content_type="<?php echo $content_type;?>" data-is_login="<?php echo $login;?>" data-type="lx_articulate">
		<div class="card-image">
			...
			<div class="div_bottom div_bottom_course" style="background: <?php echo $style_2_tiles_interface['completion_bg_color']; ?>;opacity: 95%;height:50px;display: flex;align-items: center;">
				<?php if( $open_in != "lightbox" ){ ?>
					<a href="<?php echo get_permalink($post->ID);?>" style="width:100%;margin:auto;">
						<span style="float: right;">
							<button  class="btn_normal_state btn-view" data-status="<?php echo $completed;?>">View</button>
						</span>
					</a>
				<?php }else{
					?>
