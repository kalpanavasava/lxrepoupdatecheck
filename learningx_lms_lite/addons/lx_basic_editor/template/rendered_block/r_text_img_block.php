	...
	<div class="row">
		<div class="col-md-6">
			...
			<div contenteditable="true" name="lx_editor_textimg_area lx_editor_textimg_area<?php echo $section_id;?>" data-section_id="<?php echo $section_id;?>" id="lx_editor_textimg_area<?php echo $section_id;?>" class="lx_editor_textimg_area lx_editor_textimg_area<?php echo $section_id;?> lxed_inp_css">
				<?php echo stripslashes($_POST['rend_textonly_img_block_array'][$section_id]);?>
			</div>
		...
		<div class="col-md-6">
			<div class="image-upload">
			  <label for="lxed_txt_img_block_inp<?php echo $section_id;?>">
				<img class="lxed_txt_img_block_inpimg lxed_txt_img_block_inpimg<?php echo $section_id;?>" data-section_id="<?php echo $section_id;?>" src="<?php echo $_POST['rend_text_imgonly_block_array'][$section_id];?>" style="border:1px solid <?php echo $color_palette['black'];?>;width:100%;" />
			  </label>
