...
if($info=='community_info'){
	include $lx_plugin_paths['lx_lms_lite'].'template/tiles/community/style3_ui.php';
}elseif($info=='course_info'){
	include $lx_plugin_paths['lx_lms_lite'].'template/tiles/course/style3_ui.php';
}else{
	include $lx_plugin_paths['lx_lms_lite'].'template/tiles/course_content/style3_ui.php';
}
?>